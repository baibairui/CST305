...
void updateLighting()
{
    ...
    // 应用光照强度
    GLfloat ambient0[] = {0.6f * adjusted_intensity, 0.6f * adjusted_intensity, 0.6f * adjusted_intensity, 1.0f};
...
void drawWalls()
{
    ...
    GLfloat mat_ambient[] = {0.5f, 0.5f, 0.5f, 1.0f};  // 原本 0.25
    GLfloat mat_diffuse[] = {0.8f, 0.8f, 0.8f, 1.0f};  // 原本 0.35
    GLfloat mat_specular[] = {0.7f, 0.7f, 0.7f, 1.0f}; // 原本 0.5
    GLfloat mat_shininess[] = {25.0f};                 // 可保持不变
...
void loadTextures()
{
    groundTexture = loadTexture("image copy 9.png"); // 替换为您的地面纹理文件
    wallTexture = loadTexture("image copy 11.png");   // 替换为您的墙壁纹理文件
    baseTexture = loadTexture("image copy 12.png");
